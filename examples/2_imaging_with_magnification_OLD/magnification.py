...
ideal imaging system with magnification.
"""
...
def main():
    ...
    # system:
    data_source = TrainingData_for_Telescope(coords, radius=3, magnification=-2)
...
class TrainingData_for_Telescope:
    """2d imaging by an ideal imaging system with magnification.

    This generates input/output pairs that image a pointlike source at
    the 2d input plane to an inverted and scaled image at the output
    plane.
    """
    def __init__(self, coordinates, radius, magnification):
    ...
    def input_output_pair(
        ...
        # Desired output beam is a scaled image of the same point:
